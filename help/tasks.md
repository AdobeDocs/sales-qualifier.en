...
The **[!UICONTROL Agent suggestions]** tab lists prospects that match a workflow's targeting criteria and are recommended for enrollment. To turn on recommendations, see [Outbound workflows](outbound-workflows.md).
...
On a workflow's **[!UICONTROL Engaged prospects]** view, a manual touchpoint provides the same **[!UICONTROL Mark as complete]**, **[!UICONTROL Skip]**, and notes options. Completing a task there also updates its status on the **[!UICONTROL Tasks]** page. See [Outbound workflows](outbound-workflows.md).
